        ...
        await client.answer_inline_query(query.id,
            results=[
                InlineQueryResultArticle(
                    ...
                    f"<b>🔥I am</b> {random.randint(1, 100)}<b>% Horny!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your horyness! 🔥", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🏳️‍🌈I am</b> {random.randint(1, 100)}<b>% Gay!</b>", disable_web_page_preview=True),
                ...
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>💜I am</b> {random.randint(1, 100)}<b>% lezbian!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your Lezbianess! 💜", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🧠I am</b> {random.randint(1, 100)}<b>% iq!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your iq! 🧠", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>😫I am</b> {random.randint(1, 100)}<b>% Tired!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your tiredness! 😫", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🥺I am</b> {random.randint(1, 100)}<b>% Cute!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your cuteness! 🥺", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🦶 My foot size is</b> {random.randint(1, 100)}<b>!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your foot size! 🦶", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🍒 My boobs size is</b> {random.randint(1, 100)}<b>!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your boobs size! 🍒", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🍆 My cock size is</b> {random.randint(1, 100)}<b>inch!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your cock size! 🍆", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    input_message_content=InputTextMessageContent(
                    f"<b>🍑 My ass is</b> {random.choice(ass)} <b>!</b>", disable_web_page_preview=True),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Share your ass size! 🍑", switch_inline_query=''),
                        ]]
                    )
                ),
                InlineQueryResultArticle(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                        InlineKeyboardButton("Repo! 💻", url="https://github.com/Team-Aasf/HowAllBot"),
